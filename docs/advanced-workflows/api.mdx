...
[See API Reference](/api-reference/workflows/get-workflow-data-by-its-id)
...
You can now test the updated workflow by using the [/run](/api-reference/workflows/run-a-specific-workflow) endpoint and fetch the result data.
...
[See API Reference](/api-reference/workflows/delete-a-specific-workflow)
