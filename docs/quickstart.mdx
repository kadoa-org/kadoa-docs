...
<Note>Use this option if you want to monitor the main information on a website, such as a directory of products, news, events, or jobs.</Note>
...
<Note>Use this option if you want to select specific data on a page to monitor. This "What You See Is What You Get" approach is usually the better choice for precise monitoring.</Note>

1. Install the [Kadoa Chrome Extension](https://kadoa.com/chrome-extension).
