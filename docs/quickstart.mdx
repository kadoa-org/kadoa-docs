...
In your Kadoa dashboard, click "Add Workflow".
Give your workflow a name, paste in the URL of the website you want to extract data from, and select the type of data you're looking for (e.g. custom, ecommerce products, job listings, etc.)
