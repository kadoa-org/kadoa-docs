...
-   what entity to look for in source data
-   what fields to extract for the selected entity.

For example, entity might be news, comments, etc.  
And for news, fields might be title, date, summary, etc.

## How do I manage my data schemas?

To create a new schema:

-   [Add a workflow](https://www.kadoa.com/add)
-   Select Auto-detect
-   Enter data source URL and wait for Kadoa to detect entities and fields
-   Edit the fields as needed
-   Click Save as data schema
