...
Kadoa provides [ready-made templates](https://www.kadoa.com/templates) for popular use cases. 

These templates come with a set of standard fields that Kadoa will extract, but you can still customize them based on your specific needs.
