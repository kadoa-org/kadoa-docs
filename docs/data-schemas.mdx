...
- Go to the 'Schemas' tab on your dashboard and click 'Add New Schema.' You can now reuse a schema from an existing workflow.   Note: This option is currently not available for workflows that already use a pre-defined schema.
- Give your schema a name and description
- That's it! You can now create workflows with this schema, and the data will be automatically extracted and transformed into your desired format, regardless of the source.
...
When you [create a new workflow](https://kadoa.com/add), you can choose to use one of your custom or customized schemas.
