...
The `events` array should contain the list of events you want to subscribe to. You can fetch the list of available events by making a GET request to the [events endpoint](/api-reference/webhooks/list-all-webhook-event-subscriptions).
