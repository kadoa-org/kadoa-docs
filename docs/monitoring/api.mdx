...
The Kadoa API lets you manage your workflows that have monitoring turned on. You can:

- Get all active workflows that have real-time monitoring enabled.
- Get historical data changes for one workflow or many workflows.
