...
For higher-volume or more complex use cases, explore Kadoa’s [Workflow](https://www.kadoa.com/docs/workflow) or [Crawling](https://www.kadoa.com/docs/crawl) features.Below is a documentation outline for the **Adhoc** endpoint, mirroring the structure and style used in the **Crawling** example.