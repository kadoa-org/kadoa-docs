...
The Kadoa Chrome extension operates within the user’s active tab. Here’s the complete list of requested permissions:

- [activeTab](https://developer.chrome.com/docs/extensions/develop/concepts/activeTab) - to read and modify the current web page.
- [storage](https://developer.chrome.com/docs/extensions/reference/api/storage#permissions) - to persist the entered API key in the browser’s local storage.
...
The information that the Kadoa extension sends to our servers includes:
